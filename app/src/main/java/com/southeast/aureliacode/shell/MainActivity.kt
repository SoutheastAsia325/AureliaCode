package com.southeast.aureliacode.shell
...
class MainActivity : ComponentActivity() {
  ...
  companion object {
    ...
    const val ACTION_UPDATE = "com.southeast.aureliacode.shell.action.UPDATE"
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    // Testable update trigger: adb am start -n .../.MainActivity -a com.southeast.aureliacode.shell.action.UPDATE
