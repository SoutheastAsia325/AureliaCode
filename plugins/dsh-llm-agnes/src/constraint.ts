...
export function applyConstraint(
  ...
  if (Array.isArray(messages)) {
    (messages as unknown[]).unshift({ role: 'system', content: constraint });
    injected.add(request as object);
    return true;
  }
 ...
 * @returns 约束正文。
 */
export function constraintPreview(): string {
